...
- **APIC**: [_on-chip advanced programmable interrupt controller_](https://ru.wikipedia.org/wiki/APIC) - улучшенный программируемый контроллер прерываний.
...
- FSC: fast system calls
- NX: no-execute bit
- x86-64: 64bits extensions
- RDTSCP
- constant_tsc
- arch_perfmon
- pebs
