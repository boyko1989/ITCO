...
Эта опция в Xubuntu 22.10 расположена в **_Настройки_** -> **_Хранитель экрана_**. Там выключаем всё, что связано с блокировкой экрана и самого хранителя. Затем, переходим в настройках же в **_Менеджер питания_** и во вкладке _Дисплей_ не выключая настройки питания для экрана, переводим всё что только можно в режим _"Никогда"_.
